#!/bin/bash
#===============================================
# Description: 1806_x64_temp DIY script part 2
# File name: 1806_x64_temp_diy-part2.sh
# Lisence: MIT
# By: GXNAS
#===============================================
...
# 修改版本号
sed -i "s/DISTRIB_DESCRIPTION='*'/DISTRIB_DESCRIPTION='OpenWrt_1806_x64_临时版 by GXNAS build @R$(date +%y.%m.%d) '/" package/lean/default-settings/files/zzz-default-settings
