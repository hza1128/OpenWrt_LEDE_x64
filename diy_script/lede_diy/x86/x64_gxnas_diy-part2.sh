...
# File name: x64_gxnas_diy-part2.sh
# Lisence: MIT
# By: GXNAS
#===============================================
...
sed -i 's/LEDE R24.10.24/OpenWrt_x64_旁路由版 by GXNAS build @R$(date +%y.%m.%d) /' package/lean/default-settings/files/zzz-default-settings
