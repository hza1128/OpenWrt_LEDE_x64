...
# File name: x64_soot_diy-part2.sh
# Lisence: MIT
# By: GXNAS
#===============================================
...
# 修改版本号
sed -i "s|DISTRIB_REVISION='.*'|DISTRIB_REVISION='OpenWrt_x64_精简版 by GXNAS build @R$(date +%y.%m.%d)'|g" package/lean/default-settings/files/zzz-default-settings
